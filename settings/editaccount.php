...
<title><?php echo $edit_account_info_title; ?></title>
...
<li class="border-left my-messages" style="position:relative;width:100%;border-left:0"><h4><a class="back" href="../settings" ><?php echo $back; ?> </a><?php echo $edit_acc_info_label; ?></h4></li>
...
<span><?php echo $info_username; ?></span>
<input type="text" class="user-name" placeholder="<?php echo $user["thisisuser_name"]; ?>" />

<span><?php echo $info_name; ?></span>
<input type="text" class="name"  placeholder="<?php echo $user["thisis_name"]; ?>"/>

<span><?php echo $info_country; ?></span>
<input type="text" class="country" placeholder="<?php echo $user["thisisuser_country"]; ?>"/>

<button class="editaccount"><?php echo $update_info_label; ?></button>
