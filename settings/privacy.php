...
$execute_update_v = mysqli_query($db,$update_views_query);
 ...
 <title><?php echo $privacy_sett_title; ?></title>
...
<li class="border-left my-messages" style="position:relative;width:100%;border-left:0"><h4><a class="back" href="../settings" ><?php echo $back; ?></a><?php echo $privacy_settings_label; ?></h4></li>
...
<span style="margin-bottom:20px"><?php echo $messages_num_privacy; ?></span>

<select class="privacy" style="width:100%;margin-bottom:20px;">
<option value="public" <?php if ($id["privacy"] == "public") {echo "selected";} ?>><?php echo $public; ?></option>
<option value="private" <?php if ($id["privacy"] == "private") {echo "selected";} ?>><?php echo $private_; ?></option>
</select>

<button class="update-privacy" style="background-color:white;color:#ed2553;width:100%"><?php echo $save; ?></button>
